"""
Django settings for late_base_45337 project.
...
ROOT_URLCONF = 'late_base_45337.urls'
...
WSGI_APPLICATION = 'late_base_45337.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_base_45337 API",
    "DESCRIPTION": "API documentation for late_base_45337 App",
    "VERSION": "v1",
}
